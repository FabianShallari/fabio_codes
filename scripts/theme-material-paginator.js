//copy from https://github.com/hexojs/hexo/blob/master/lib/plugins/helper/paginator.js Aug.8 2015
...
function paginatorHelper(options){
  ...
  var currentPage = '<li class="active">' +
  ...
  function pageLink(i){
    return '<li class="waves-effect"><a href="' + link(i) + '">' +
  ...
  if (options.show_all){
    ...
    var spaceHtml = '<li class="disabled">' + space + '</li>';
